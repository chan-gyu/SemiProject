 ...
 */
@WebServlet("/member/memberupdateConn")
public class MemberupdateConn extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberupdateConn() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/view/member/memberInfoUpdate.jsp").forward(request, response);
	}
