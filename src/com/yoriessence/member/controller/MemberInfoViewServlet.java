...
/**
 * Servlet implementation class MemberInfoViewServlet
 */
@WebServlet("/member/memberInfoUpdate")
public class MemberInfoViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberInfoViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(m!=null) {
			view="/view/member/memberInfoUpdate.jsp";
		}else {
