...
public class NoticeWriteEndServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 개발자가 직접 작성할 수도 있고, 기본적으로 제공하는 클래스가 있음(DefaultFileRenamePolicy)
		
		//파일업로드하기
		//MutipartRequest클래스를 작성 -> request로 전송된 데이터가 지정한 경로에 저장
		//MutipartRequest클래스 생성자는 5개의 매개변수를 가지고 있음
		...
		Notice n=new Notice();
		n.setTitle(mr.getParameter("noticeTitle"));
		n.setContent(mr.getParameter("content"));
